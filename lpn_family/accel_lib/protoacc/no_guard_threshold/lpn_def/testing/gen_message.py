...
#     if depth > 3:  # Limiting the depth of recursion
#         return None
    
#     message = {}
#     num_fields = random.randint(1, 5)  # Number of fields in the submessage
#     for i in range(num_fields):
#         field_type = random.choice(['scalar', 'non-scalar', 'submessage'])
#         is_repeated = random.choice([True, False])  # Decide if the field is repeated
